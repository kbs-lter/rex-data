...
qiime phylogeny fasttree --i-alignment 16S-2021-masked-aligned-rep-seqs.qza --o-tree 16S-2021-fasttree-unrooted-tree.qza --verbose
...
# read in data
seq_metadata <- read.csv(file.path(dir, "microbes/16S & ITS/T7_warmx/L0/2021/files to create REX 16S 2021 metadata/sequence_2021_metadata.csv"))
...
write.csv(bacterial_2021_metadata, file = "/Users/moriahyoung/Desktop/phyloseq_object/bacterial_2021_metadata.csv", row.names = F)
```
...
write.csv(SVs16Stable, file = "/Users/moriahyoung/Downloads/16S-2021-merged-dada2table.csv")
...
write.csv(tax16S, file = "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-taxonomy.csv", row.names =F)
```
...
data_16S_unfiltered <- read_csv2phyloseq(otu.file = "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-merged-table.csv",
                                         taxonomy.file = "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-taxonomy.csv",
...
write.csv(data_16S_uf4@otu_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-merged-table-filtered.csv")
write.csv(data_16S_uf4@tax_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-taxonomy-filtered.csv")
...
ps.pa.neg_soil <- prune_samples(sample_data(ps.pa_soil)$Sample_or_Control == "Control Sample", ps.pa_soil) # no contaminants then?
...
# to desktop
# otu table
write.csv(ps.noncontam_soil1@otu_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-table-filtered-noncontam.csv")
# taxonomy table
write.csv(ps.noncontam_soil1@tax_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-2021-taxonomy-filtered-noncontam.csv")

# upload these to REX google shared drive
# update path
# otu table
write.csv(ps.noncontam_soil1@otu_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2021/files to create phyloseq object/16S-2021-table-filtered-noncontam.csv"), row.names=F)
# taxonomy table
write.csv(ps.noncontam_soil1@tax_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2021/files to create phyloseq object/16S-2021-taxonomy-filtered-noncontam.csv"), row.names=F)
```
