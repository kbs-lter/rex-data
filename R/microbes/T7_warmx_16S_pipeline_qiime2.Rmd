...
qiime phylogeny raxml \
  ...
  --o-tree 16S-2021-raxml-cat-tree.qza \
  --verbose
  
qiime phylogeny raxml --i-alignment 16S-2021-masked-aligned-rep-seqs.qza --p-substitution-model GTRCAT --o-tree 16S-2021-raxml-cat-tree.qza --verbose

OR 
# using fasttree
# this worked better for me and it was fast
qiime phylogeny fasttree \
  --i-alignment 16S-2021-masked-aligned-rep-seqs.qza \
  --o-tree 16S-2021-fasttree-tree.qza
  --verbose
