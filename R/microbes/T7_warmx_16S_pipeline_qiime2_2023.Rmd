...
bacterial_2023_metadata <- bacterial_2023_metadata[, c("Sample_ID", "RTSF_SampleID", "Barcode",
                                                       ...
                                                       "Subplot", "Subplot_Location", "Drought", "Warming",
                                                       "Insecticide", "Subplot_Descriptions",
                                                       "Unique_ID", "Date", "Sample_or_Control")]
...
# upload to desktop
# otu table
write.csv(data_16S_uf4@otu_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-merged-table-filtered.csv")
# taxonomy table
write.csv(data_16S_uf4@tax_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-taxonomy-filtered.csv")

# upload these to REX google shared drive
# otu table
write.csv(data_16S_uf4@otu_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2023/files to create phyloseq object/16S-merged-table-filtered.csv"), row.names=F)
# taxonomy table
write.csv(data_16S_uf4@tax_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2023/files to create phyloseq object/16S-taxonomy-filtered.csv"), row.names=F)
```
...
```{r}
# from https://github.com/longleyr/Management-of-Soybean-Code-and-Files/blob/master/fungi_analysis_script.R
...
# to desktop
# otu table
write.csv(ps.noncontam_soil@otu_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-merged-table-filtered-noncontam.csv")
# taxonomy table
write.csv(ps.noncontam_soil@tax_table, "/Users/moriahyoung/Desktop/phyloseq_object/16S-taxonomy-filtered-noncontam.csv")

# upload these to REX google shared drive
# update path
# otu table
write.csv(ps.noncontam_soil@otu_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2023/files to create phyloseq object/16S-merged-table-filtered-noncontam.csv"), row.names=F)
# taxonomy table
write.csv(ps.noncontam_soil@tax_table, file.path(dir,"microbes/16S & ITS/T7_warmx/L0/2023/files to create phyloseq object/16S-taxonomy-filtered-noncontam.csv"), row.names=F)
```
