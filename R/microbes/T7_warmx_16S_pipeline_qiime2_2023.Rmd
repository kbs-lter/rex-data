...
qiime dada2 denoise-paired --i-demultiplexed-seqs 20240415_16SV4_PE250.qza \
--p-trim-left-f 0 \
--p-trim-left-r 0 \
...
--o-representative-sequences 20240415_16SV4_PE250-rep-seqs.qza \
--o-denoising-stats 20240415_16SV4_PE2503-denoising-stats.qza \
--p-n-threads 36
...
qiime dada2 denoise-paired --i-demultiplexed-seqs 20240415_16SV4_PE250.qza --p-trim-left-f 0 --p-trim-left-r 0 --p-trunc-len-f 250 --p-trunc-len-r 250 --o-table 20240415_16SV4_PE250-dada2table.qza --o-representative-sequences 20240415_16SV4_PE250-rep-seqs.qza --o-denoising-stats 20240415_16SV4_PE250-denoising-stats.qza --p-n-threads 36 --verbose
